...
public class Size_Adapter extends RecyclerView.Adapter<Size_Adapter.Productdetailhoder>{
    ...
    int selectedPos = 0;
    GetMoney get_money;
    public Size_Adapter(List<ProductDetails> list, Context context, GetMoney get_money) {
        this.list = list;
    ...
    @NonNull
    @Override
    public Size_Adapter.Productdetailhoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Size_Adapter.Productdetailhoder holder, int position) {
